...
app.get('/api/datarooms', (req: Request, res: Response) => {
    res.json({
...
app.post('/api/datarooms', (req: Request, res: Response) => {
    res.json({
...
app.get('/api/datarooms/:id/folders', (req: Request, res: Response) => {
    res.json({
...
app.post('/api/datarooms/:id/folders', (req: Request, res: Response) => {
    res.json({
...
app.post('/api/datarooms/:id/upload', (req: Request, res: Response) => {
    res.json({
